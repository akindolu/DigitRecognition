...
numpy.savetxt('mnist-resampled8x-CNN-50epoch-dada.csv', numpy.c_[range(1,len(y_test)+1),y_test], delimiter=',', header = 'ImageId,Label', comments = '', fmt='%d')